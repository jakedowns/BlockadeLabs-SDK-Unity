...
namespace BlockadeLabsSDK
{
    ...
    public class BlockadeImaginariumEditor : Editor
    {
        ...
        private SerializedProperty resultDepth;
        ...
        private SerializedProperty saveAsAssets;
        private SerializedProperty saveAsImages;
        ...
        void OnEnable()
        {
            ...
            resultDepth = serializedObject.FindProperty("resultDepth");
            ...
            saveAsAssets = serializedObject.FindProperty("SaveAsAssets");
            saveAsImages = serializedObject.FindProperty("SaveAsImages");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showBasic)
            {
                ...
                EditorGUILayout.PropertyField(saveAsAssets);
                EditorGUILayout.PropertyField(saveAsImages);
            }
            ...
            if (!EditorApplication.isPlayingOrWillChangePlaymode)
            {
                ...
                if (showOutput)
                {
                    ...
                    EditorGUILayout.PropertyField(resultDepth);
